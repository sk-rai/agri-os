...
| Field-agent mode | Ready for Android MVP | GET /api/v1/field-agent/worklist, agent profiles/admin page, profile readiness, `docs/android-persona-lifecycle-test.md` | Test agent-assisted enrollment, dual farmer/agent mode switch, worklist flows, and agent reassignment | Confirm Android role switching UX with real token/tenant data |
