...
| Android persona lifecycle extensions | Active next | Android closure plan added for project picker, independent/project transition, duplicate cleanup, and agent reassignment UI flows. Multi-village parcel and FPO-scale affiliated farmer scenarios are documented as supported backend mechanics but separate optional Android/demo follow-ups. | `docs/android-persona-extension-android-closure-plan.md`, `backend/scripts/prepare_android_persona_lifecycle_extensions.py`, `backend/scripts/verify_android_persona_lifecycle_extensions.py`, `docs/android-persona-lifecycle-extension-tests.md` |
