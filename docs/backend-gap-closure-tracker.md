...
| Android FPO search and drill-down smoke | Active next | Added verifier/docs for FPO enrollment search by village/crop/mobile/source plus project-trace crop/status/farmer drill-down and Android-visible farmer hydration/crop-cycle drill-down. | backend/scripts/verify_android_fpo_search_drilldown.py, docs/android-fpo-multi-village-workflow-test.md |
