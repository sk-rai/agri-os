...
| CoRE polygon export + LGD overlay | Active next | District overlay candidates are ready for manual review: 2,355 rows across 785 districts and 3 CoRE systems. DB import remains blocked on Bharatlas source/provenance, low-overlap review, and area-method decision. | `backend/scripts/review_core_lgd_overlay_candidates.py`, `docs/core-lgd-overlay-candidate-review.md` |
