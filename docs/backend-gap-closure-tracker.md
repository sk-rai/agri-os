...
| Android crop-cycle test fixture | Watch during Android | Dedicated repeatable farmer/parcel fixture added for crop-cycle creation Maestro tests; eligible-parcels returns a bare array with one ELIGIBLE parcel after reset. | `backend/scripts/seed_android_crop_cycle_test_fixture.py`, `docs/android-crop-cycle-test-fixture.md` |
