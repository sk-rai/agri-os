...
| Android FPO multi-village workflow smoke | Active next | Added deterministic FPO tenant/project fixture for 12 affiliated farmers across 4 villages, 4 crops, and mixed workflow stage statuses, with verifier covering Android-visible enrollment, hydration, crop-cycle, and admin trace/filter APIs. | ackend/scripts/prepare_android_fpo_multi_village_workflow.py, ackend/scripts/verify_android_fpo_multi_village_workflow.py, docs/android-fpo-multi-village-workflow-test.md |
