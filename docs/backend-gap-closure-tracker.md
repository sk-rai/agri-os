...
| FPO search and drill-down smoke | Active next | Backend verifier and Playwright smoke are green for project enrollment search by village/crop/mobile plus project-trace crop/status/farmer drill-down. Next: Android Flow should assert the same evidence contract. | backend/scripts/verify_android_fpo_search_drilldown.py, web/smoke/fpo_project_enrollment_search_smoke.mjs, docs/android-fpo-multi-village-workflow-test.md |
