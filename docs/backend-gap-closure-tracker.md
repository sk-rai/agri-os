...
| CoRE polygon export + LGD overlay | Active next | Manual-review import plan added. Of 2,355 polygon-derived district/region candidates, 2,298 would be staged as inactive MANUAL_REVIEW candidates and 57 would be excluded for LGD/source-version issues. No fallback rows are replaced; DB import remains blocked on review/promotion workflow. | `backend/scripts/plan_core_lgd_manual_review_import.py`, `docs/core-lgd-manual-review-import-plan.md`, `docs/core-lgd-low-overlap-review.md` |
