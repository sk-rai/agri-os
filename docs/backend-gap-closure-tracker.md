...
| Android land-intelligence summary screen | Active next | Proposed backend-driven read-only Android summary for region, season, climate/weather, soil, water context, suitable main crops, and alternate crops. V1 is informational; V2 can add clickable details and richer evidence. | `docs/admin-localization-and-land-intelligence-summary-plan.md` |
