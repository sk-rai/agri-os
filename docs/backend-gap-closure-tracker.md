...
| Admin localization overrides | Active next | Proposed admin-managed translation/content override surface for backend-driven form labels, option sets, crop stages, inputs, and land-intelligence copy. Keep Android as renderer; preserve English fallback and workflow semantics. | `docs/admin-localization-and-land-intelligence-summary-plan.md` |
