...
def main():
    ...
    check(counts["approved_for_promotion_count"] == 580, "Five hundred eighty profiles remain approved after rollout checkpoints", counts)
    check(counts["active_promoted_profile_row_count"] == 580, "Five hundred eighty profiles are promoted and active for web/admin verification", counts)
