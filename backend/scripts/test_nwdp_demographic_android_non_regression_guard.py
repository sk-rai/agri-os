...
def main():
    ...
    check(counts["remaining_eligible_profile_row_count"] == 1570, "One thousand five hundred seventy approved inactive profiles remain eligible after duplicate-safe promotion", counts)
