...
DEFAULT_OUTPUT = (
    CAMPAIGN_DIR
    / "nwdp_post_lgd_staging_engine_report.json"
)

PROPOSAL_CHECKSUM = "80bbbe640c7675d9d9882c3489e53cc481159eee222341e03d24a3121d7d0cae"
AUTHORIZATION_CHECKSUM = "ac9682fccf9e01d9eb7d50be114828375e9b9dfb46b1f5d3520e589be79f6c83"
NATIONAL_MANIFEST_SHA256 = "32bef4c7f99af2792410a2505d70d56f7fe42d126388de37e9ed376e8043a139"
MANIFEST_CHECKSUM = "72663edc2b5e27273d7d8516c40842f97358842d4cde2a1a215353b3b281e16a"
MANIFEST_FILE_SHA256 = "ce78c6ad48541069d3c949a1e8ae78cd4eb1af856014b361cfa1db7348191a76"
INITIAL_CHECKPOINT_CHECKSUM = "178eb1ac126a33e50a8e707f4d555a101190da9b0453133105a85caed871864c"
...
MARKER = "nwdp_post_lgd_staging"
SCHEMA_VERSION = "nwdp_post_lgd_staging_state_engine.v1"

REVIEWER_ID = "nwdp-post-LGD deterministic-rehabilitation"
REVIEWER_NOTES = (
    "Checksum-pinned post-LGD deterministic village identity approved for "
...
PROPOSAL_FILE_SHA256 = "1ebe99f17e952985c2db40991666bc1babbc1e17f2679ba8174126c75335f0f5"
AUTHORIZATION_FILE_SHA256 = "b786c1b6f8192d52560a2caca9f5044597c5f3d67ca19f7d9edf37874ef73112"
...
def validate_mutation_gates(
    ...
    required = {
        "enable":
            options.enable_post_lgd_staging_write,
...
def validate_artifacts(
    ...
    checks = {
        "manifest_schema":
            ...
            == "nwdp_post_lgd_staging_manifest.v1",
        "manifest_healthy":
        ...
        "proposal_schema":
            ...
            == "nwdp_post_lgd_staging_proposal.v1",
        "proposal_status":
            proposal.get("status")
        ...
        "runtime_set":
            ...
            == RUNTIME_SET_ID,
        "single_writer":
            checkpoint.get("single_writer") is True
            and checkpoint.get("writer_count") == 1,
    }
...
def selected_rows(
    ...
    rows = connection.execute(text(r"""
        ...
        select
          ...
          input.row_sha256,
          input.nwdp_name_disposition as name_disposition,
...
def apply_batch(
    ...
    review_rows = connection.execute(text(r"""
        ...
        set
          ...
          reviewer_decision =
            'ACCEPT_POST_LGD_STAGING_VILLAGE_MATCH',
