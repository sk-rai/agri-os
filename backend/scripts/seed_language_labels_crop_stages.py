...
STAGE_HI_BY_CODE = {
    ...
    "GERMINATION": "अंकुरण",
    "PLANTING": "रोपण",
    "EMERGENCE": "अंकुर निकलना",
    "VEGETATIVE": "वानस्पतिक वृद्धि",
    "TILLERING": "कल्ले निकलना",
    "CROWN_ROOT": "जड़ विकास",
    "GRAND_GROWTH": "तेज वृद्धि",
    "FLOWERING": "फूल आना",
    "TASSELING": "नर फूल और भुट्टा रेशम अवस्था",
    "HEADING": "बाली निकलना / फूल आना",
    "POD_FORMATION": "फली बनना",
    "POD_DEVELOPMENT": "फली विकास",
    "FRUITING": "फल बनना",
    "POD_FILLING": "फली भरना",
    "SILIQUA": "सिलीक्वा बनना",
    "BOLL_FORMATION": "टिंडा बनना",
    "TUBER_BULKING": "कंद बढ़ना",
...
STAGE_HI_BY_NAME = {
    ...
    "tillering": "कल्ले निकलना",
    "crown root initiation": "जड़ विकास",
    "grand growth": "तेज वृद्धि",
    "flowering": "फूल आना",
    "tasseling/silking": "नर फूल और भुट्टा रेशम अवस्था",
    "heading/flowering": "बाली निकलना / फूल आना",
    "heading / flowering": "बाली निकलना / फूल आना",
    "pod formation": "फली बनना",
    "pod development": "फली विकास",
    "fruiting": "फल बनना",
    "pod filling": "फली भरना",
    "siliqua formation": "सिलीक्वा बनना",
    "boll formation": "टिंडा बनना",
    "tuber bulking": "कंद बढ़ना",
