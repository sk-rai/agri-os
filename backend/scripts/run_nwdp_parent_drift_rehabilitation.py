...
DEFAULT_PROPOSAL = (
    CAMPAIGN_DIR
    / "nwdp_parent_drift_proposal.json"
)
DEFAULT_AUTHORIZATION = (
    CAMPAIGN_DIR
    / "nwdp_parent_drift_authorization.json"
)
DEFAULT_CHECKPOINT = (
    CAMPAIGN_DIR
    / "nwdp_parent_drift_checkpoint.json"
)
DEFAULT_OUTPUT = (
    CAMPAIGN_DIR
    / "nwdp_parent_drift_engine_report.json"
)

PROPOSAL_CHECKSUM = (
    "277bc7d767daa68111b26cc4de8157d8"
    "7fc4796ebb649eac119eb7d87d815af0"
)
AUTHORIZATION_CHECKSUM = (
    "c90b3ff07c0228b0122488db433d9d69"
    "eeca957ad1bcd4c48ef2fea4575f81e6"
)
NATIONAL_MANIFEST_SHA256 = (
    "b9748e503dc0ee0412c350125039bf163"
    "b63b4f596896904b5ba23db88d2f5db"
)
MANIFEST_CHECKSUM = (
    "50fd3c9dc2d1a7251793d41927f116cc"
    "5e32612793e6cc606199d517d5cb55a0"
)
MANIFEST_FILE_SHA256 = (
    "8b428536a6e97759a2fa87dd38bca33e"
    "543be7e4106ea74ee3e18dd900af2d5b"
)
INITIAL_CHECKPOINT_CHECKSUM = (
    "d6ad2963330cb5425d2e26665cae5062"
    "1f7bcca620f41b6d6ef5f3852a443b7a"
)
...
MARKER = "nwdp_parent_drift_rehabilitation"
SCHEMA_VERSION = (
    "nwdp_parent_drift_state_engine.v1"
)

REVIEWER_ID = "nwdp-parent-drift-rehabilitation"
REVIEWER_NOTES = (
    "Checksum-pinned parent-drift village identity approved for "
    "inactive runtime staging; canonical parent remains authoritative."
)
...
PROPOSAL_FILE_SHA256 = (
    "62d6b1ee9d47b9f6c08f4334f8f5907"
    "d6c08dd2d4d2cab1df288ed73ebff2abd"
)
AUTHORIZATION_FILE_SHA256 = (
    "e3d28ac82acdd0d085bf5811b95ea132"
    "969e41fc973c38704b2a20a7f5efc494"
)
...
def arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--enable-parent-drift-rehabilitation-write",
        action="store_true",
    )
    parser.add_argument(
...
def validate_mutation_gates(
    ...
    required = {
        "enable":
            options.enable_parent_drift_rehabilitation_write,
...
def validate_artifacts(
    ...
    checks = {
        ...
        "authorization_schema":
            ...
            == "nwdp_parent_drift_authorization.v1",
        ...
        "checkpoint_schema":
            ...
            == "nwdp_parent_drift_checkpoint.v1",
        "checkpoint_manifest":
...
def apply_batch(
    ...
    review_rows = connection.execute(text(r"""
        ...
        set
          ...
          reviewer_decision =
            'ACCEPT_PARENT_DRIFT_VILLAGE_MATCH',
