#!/usr/bin/env python3
"""Three-row transactional boundary validation metadata fixture."""
...
SCHEMA_VERSION = (
    "boundary_geometry_validation_metadata_multi_row_fixture.v1"
)
...
PLAN_CHECKSUM = (
    "128f9bbfa5a18d2c7a2be338ab3ab7b9a5a80acac7133e990662e4b1ae0d0c47"
)
...
FIXTURE_IDS = [
    "9a18114f-5350-5173-97df-f24e1e64c30b",
    "5b16f470-8040-57d9-a1d5-fb8fd2f1efe2",
    "f3fdab0a-b6b9-5169-b72c-645269ddd561",
]
FIXTURE_INDEXES = [0, 1, 2]
MARKER = "bounded_validation_metadata_fixture"
...
def arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--operator", default="admin-regression")
...
def validate(args: argparse.Namespace, plan: dict[str, Any]) -> None:
    ...
    if plan["batch"]["selected_row_count"] != 3 or len(rows) != 3:
        raise ValueError("EXACT_THREE_ROW_FIXTURE_REQUIRED")
...
def main() -> int:
    ...
    audit = {
        ...
        "healthy": healthy,
        "mode": (
            "MULTI_ROW_VALIDATION_METADATA_ROLLBACK"
            if args.rollback
            else "MULTI_ROW_VALIDATION_METADATA_APPLY"
        ),
        "action": action,
        "error": error,
