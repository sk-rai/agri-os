...
class CropTaxonomyImportBatch(Base, UUIDPrimaryKey, AuditMixin):
    """Validated crop taxonomy CSV batch awaiting future apply/publish support."""

    __tablename__ = "crop_taxonomy_import_batches"
    ...
    __table_args__ = (
        Index("idx_crop_taxonomy_import_tenant_created", "tenant_id", "created_at"),
        Index("idx_crop_taxonomy_import_status_expiry", "status", "expires_at"),
    )


class CropPropagationImportBatch(Base, UUIDPrimaryKey, AuditMixin):
    """Validated crop propagation CSV batch awaiting apply support."""

    __tablename__ = "crop_propagation_import_batches"
...
class ProductCatalogImportBatch(Base, UUIDPrimaryKey, AuditMixin):
    """Validated product catalog CSV batch awaiting explicit admin application."""

    __tablename__ = "product_catalog_import_batches"
    ...
    __table_args__ = (
        Index("idx_product_catalog_import_tenant_created", "tenant_id", "created_at"),
        Index("idx_product_catalog_import_status_expiry", "status", "expires_at"),
    )
