...
CROP_CYCLE_CREATE_FORM = FormSchema(
    ...
    fields=[
        ...
        FormField(
            ...
            required=False,
            options=[
                FormFieldOption(value="OWN_SAVED", label={"en": "Own Saved", "hi": "अपना बचाया हुआ"}),
                FormFieldOption(value="PURCHASED_MARKET", label={"en": "Purchased (Market)", "hi": "खरीदा (बाजार)"}),
                FormFieldOption(value="PURCHASED_GOVT", label={"en": "Government Supply", "hi": "सरकारी आपूर्ति"}),
                FormFieldOption(value="PURCHASED_COMPANY", label={"en": "Company/Dealer", "hi": "कंपनी/डीलर"}),
                FormFieldOption(value="EXCHANGE", label={"en": "Exchange with farmer", "hi": "किसान से अदला-बदली"}),
            ],
        ),
    ],
)
