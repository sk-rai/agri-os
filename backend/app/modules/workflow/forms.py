...
SOIL_PROFILE_FORM = FormSchema(
    ...
    fields=[
        ...
        FormField(id="soil_color", type="single_select", label={"en": "Soil Color", "hi": "Soil Color"}, required=False, options=[FormFieldOption(value="BROWN", label={"en": "Brown", "hi": "Brown"}), FormFieldOption(value="DARK_BROWN", label={"en": "Dark brown", "hi": "Dark brown"}), FormFieldOption(value="LIGHT_BROWN", label={"en": "Light brown", "hi": "Light brown"}), FormFieldOption(value="REDDISH", label={"en": "Reddish", "hi": "Reddish"}), FormFieldOption(value="BLACK", label={"en": "Black", "hi": "Black"}), FormFieldOption(value="GREY", label={"en": "Grey", "hi": "Grey"})], canonical_field="soil_profile.soil_color"),
