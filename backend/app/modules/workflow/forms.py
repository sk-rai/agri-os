...
PARCEL_REGISTRATION_FORM = FormSchema(
    ...
    fields=[
        ...
        FormField(id="same_as_home_location", type="boolean", label={"en": "Are all land parcels in the same PIN code/village as the farmer home?", "hi": "Are all land parcels in the same PIN code/village as the farmer home?"}, required=False, default_value="true", canonical_field="parcel.location_scope.same_as_home_location", android_hint={"copy_from_farmer_fields": ["pin_code", "village_id", "village_name_manual"], "if_false_require": ["pin_code", "village_name_manual"], "village_lookup_endpoint": "/api/v1/geography/villages/by-pin-code?pin_code={pin_code}"}),
...
def _profile_contract_android_handoff() -> dict:
    return {
        ...
        "soil_enrichment": {
            ...
            "job_audit_endpoint": "/api/v1/soil-profiles/enrichments/jobs/audit",
